...
const DEMO_RESPONSES: Record<string, string> = {
  'Reduce customer churn':
    ...
    `3. **Root Cause Clustering** — NLP on exit surveys + support logs to categorise churn reasons, so product and CS can address systemic issues.\n\n` +
  ...
  'Automate invoice processing':
    ...
    `1. **Document Intelligence Pipeline** — OCR + layout-aware extraction handles PDFs, scans, and emails. Accuracy: 97.4% on Indian invoice formats (GST, e-invoices, multi-currency).\n\n` +
  ...
  'Monitor crop health via satellite':
    ...
    `2. **Disease & Stress Classification** — Vision model identifies 40+ crop diseases, water stress, and pest damage with 94% accuracy — alerts farmers via WhatsApp in Hindi/regional languages.\n\n` +
...
const services = [
  ...
  { Icon: Leaf,        accent: '#22c55e', bg: '#f0fdf4', title: 'Agriculture Tech',    desc: 'Precision farming via computer vision — crop health, yield prediction, resource optimisation.' },
...
const technologies = [
  ...
  { Icon: Bot,       color: '#0891b2', title: 'Intelligent Automation',   desc: 'RPA enhanced with AI reasoning — from rule-based tasks to complex decision workflows.' },
];
...
const testimonials = [
  ...
  { quote:"We needed a partner who understood our constraints. Eigur delivered a scalable AI solution — we've seen 3× revenue growth since.", name:'Amit Patel', title:'CEO, AgriTech Innovations' },
];
...
const whyReasons = [
  ...
  { Icon: Cpu,    title: 'Edge-Ready',         desc: 'Deploy on-premise or at the edge — full data sovereignty, no cloud lock-in.' },
...
const AIFeaturesBenefits = [
  ...
  { icon:'🗣️', title:'Speak Every Language', desc:'AI systems fluent in Hindi, Tamil, Bengali, Telugu, and 15+ regional languages — zero translation lag.' },
  { icon:'🔒', title:'On-Premise by Default', desc:'Deploy entirely within your infrastructure. Your data never leaves your servers.' },
  { icon:'⚡', title:'Production in Weeks', desc:'We deploy working AI in 4–8 weeks — not months. Agile methodology, no shelfware.' },
  ...
  { icon:'🤝', title:'Co-Innovation Partner', desc:'We embed with your team — not just deliver software. Knowledge transfer is part of every project.' },
];
